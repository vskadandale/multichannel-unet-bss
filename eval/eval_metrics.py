...
COMPARISON = os.path.join(DUMPS_FOLDER, 'stitched', TEST_UNET_CONFIG)#[resampled_output_path,phasemixed_output_path,resampled_phasemixed_ouput_path]
results_folder = os.path.join(DUMPS_FOLDER, 'results', setting)#{1.ori:mixphased,resampled,resampled_mixphased; 2.down:mixphased_10800} ##TODO stereo
